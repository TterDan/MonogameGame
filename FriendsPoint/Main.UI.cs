...
namespace FriendsPoint
{
    public partial class Main 
    {
        ...
        public void CursorUI() // Думаю удобно будет для каждого элемента интерфейса делать свой метод, в котором с ним будет удобно взаимодействовать, чтобы не засирать Draw
        {
