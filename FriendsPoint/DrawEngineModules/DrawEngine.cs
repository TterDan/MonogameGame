...
namespace FriendsPoint.DrawEngineModules {
    public partial class DrawEngine {
        ...
        static public Texture2D QuarterCircleTexture;
        static public void Init(SpriteFont font, GraphicsDevice graphicsDevice, Texture2D quarterCircleTexture) {
            GameFont = font;
            GraphicsDevice = graphicsDevice;
            TexturePixel = new Texture2D(GraphicsDevice, 1, 1);
            TexturePixel.SetData(new[] { Color.White });
            QuarterCircleTexture = quarterCircleTexture;
        }
    }
}